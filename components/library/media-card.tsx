...
export default function MediaCard({ media, imageUrl }: MediaCardProps) {
  return (
    <Link
      className="flex flex-col items-center p-2 fading-border rounded-lg hover:p-0 transition-all cursor-pointer"
      href={`${media.Type === "Movie" ? "/movies" : "/tv"}/${media.Id}`}
    >
